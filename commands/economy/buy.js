...
module.exports = {
    ...
    run: async(client, message, args) => {
        if(!args[0]) return message.reply(`What do u want to buy`)
        ...
        if(userBalance < itemPrice) return message.reply(`${client.emotes.error} • You only have ${userBalance}, the price of that item is ${itemPrice} coins!`)
        ...
        inventory.findOne(params, async(err, data) => {
            ...
            message.reply(`**${itemToBuy}** Has been added to your inventory ;b`);
